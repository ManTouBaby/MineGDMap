...
import com.hy.gdlibrary.utils.AnimationUtil;
...
public class DefaultMapActivity extends BaseMapActivity implements AMapNaviListener, InitListener {
    ...
    protected void init() {
        ...
        mTVStartNavigation.setOnClickListener(v -> startNavigation());
        tvBack = findViewById(R.id.mine_back);
        tvBack.setOnClickListener(v -> showTwo());
    ...
    private void showTwo() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle("提示")
                .setMessage("确定退出导航？").setPositiveButton("确定", (dialogInterface, i) -> {
                    //ToDo: 你想做的事情
